...
//   static final FBLoginImp _instance = FBLoginImp._internal();
//   factory FBLoginImp() => _instance;
//   FBLoginImp._internal();

//   FacebookLogin _fbLogin = FacebookLogin();
//   List<String> _permissionsRequest = const ['email', 'public_profile'];
//   String _token;
